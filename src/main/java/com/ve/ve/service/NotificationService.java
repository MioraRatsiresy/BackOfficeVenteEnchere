    ...
    private void initialize() {
        try {
            FirebaseOptions options = new FirebaseOptions.Builder()
                    .setCredentials(GoogleCredentials.fromStream(new ClassPathResource("venteenchere-dab6a-firebase-adminsdk-nfaf2-86de5ad407.json").getInputStream())).build();
